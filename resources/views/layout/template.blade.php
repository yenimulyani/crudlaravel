      ...
      <nav class="mt-2">
         ...
         @if($akses==1)
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="assets/AdminLTE-3.0.5/./index.html" class="nav-link">
              ...
              <li class="nav-item">
                <a href="assets/AdminLTE-3.0.5/./index3.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v3</p>
                </a>
              </li>
        ...
        <li class="nav-item ">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="assets/AdminLTE-3.0.5/pages/tables/simple.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Simple Tables</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="assets/AdminLTE-3.0.5/pages/tables/data.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>DataTables</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="assets/AdminLTE-3.0.5/pages/tables/jsgrid.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>jsGrid</p>
                </a>
              </li>
...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="assets/AdminLTE-3.0.5/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="assets/AdminLTE-3.0.5/plugins/raphael/raphael.min.js"></script>
<script src="assets/AdminLTE-3.0.5/plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="assets/AdminLTE-3.0.5/plugins/jquery-mapael/maps/usa_states.min.js"></script>
<!-- ChartJS -->
<script src="assets/AdminLTE-3.0.5/plugins/chart.js/Chart.min.js"></script>

<!-- PAGE SCRIPTS -->
<script src="assets/AdminLTE-3.0.5/dist/js/pages/dashboard2.js"></script>
